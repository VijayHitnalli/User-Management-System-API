...
public class UserServiceImpl implements UserService {
	...
	public ResponseEntity<ResponseStructure<UserResponse>> fetchById(int userId) {
		...
		if (optional.isPresent()) {
			...
			throw new UserNotFoundByIdException("Failde to find the userId");
		}	
	}
...
//	}
	...
	@Override
	public ResponseEntity<ResponseStructure<UserResponse>> updateUserById(int userId, @Valid UserRequest userRequest) {
